...
in {
              ...
              peers = [
                {
                  ...
                  publicKey = "cnN0cmV5dWdoamJ2Y2dmZHJldHlnaHZjZ2ZkcmVzdGZnaHZiYw==";
                }
              ];
            };
          };
  ...
  config = mkIf (cfg.interfaces != {}) {
    xdg.configFile =
      mapAttrs' generateInterfaceAttrs config.programs.wireguard.interfaces;

    home.packages = [pkgs.wireguard-go pkgs.wireguard-tools];
  };
}
